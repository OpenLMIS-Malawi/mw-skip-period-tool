...
import mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.StockAdjustmentReason;
import mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.StockAdjustmentReason.Exporter;
import mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.StockAdjustmentReason.Importer;
...
public class ReasonDto extends BaseDto implements Exporter, Importer {
  ...
  /**
   * Create new instance of RequisitionTemplateDto
   *
