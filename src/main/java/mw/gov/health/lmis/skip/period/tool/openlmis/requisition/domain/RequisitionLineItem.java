...
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateAdjustedConsumption;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateAverageConsumption;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateCalculatedOrderQuantity;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateMaximumStockQuantity;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateStockOnHand;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateTotal;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateTotalConsumedQuantity;
import static mw.gov.health.lmis.skip.period.tool.openlmis.requisition.domain.LineItemFieldsCalculator.calculateTotalLossesAndAdjustments;
